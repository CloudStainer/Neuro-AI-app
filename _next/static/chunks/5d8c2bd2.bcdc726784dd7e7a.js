    ...
    65221: function (t, e, r) {
      ...
      !(function () {
        ...
        _.versions.node
          ? (r = ta)
          : i && (r = self);
        var n = !r.JS_SHA3_NO_COMMON_JS && tl.exports,
      ...
      let td = !1,
        tp = !1,
        tm = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        tg = tm.default,
        tv = null,
        tA = (function () {
          try {
      ...
      class tb {
        ...
        _log(t, e) {
          ...
          null == tm[r] &&
            ...
            tg > tm[r] || console.log.apply(console, e);
        }
        debug(...t) {
          this._log(tb.levels.DEBUG, t);
        }
        info(...t) {
          this._log(tb.levels.INFO, t);
        }
        warn(...t) {
          this._log(tb.levels.WARNING, t);
        }
        makeError(t, e, r) {
          if (tp) return this.makeError("censored error", e, {});
          e || (e = tb.errors.UNKNOWN_ERROR), r || (r = {});
          let i = [];
        ...
        throwArgumentError(t, e, r) {
          return this.throwError(t, tb.errors.INVALID_ARGUMENT, {
            argument: e,
            value: r,
          });
        }
        ...
        checkNormalize(t) {
          tA &&
            this.throwError(
              ...
              { operation: "String.prototype.normalize", form: tA }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
            ...
            (t < 0 || t >= 9007199254740991) &&
              this.throwError(e, tb.errors.NUMERIC_FAULT, {
        ...
        checkArgumentCount(t, e, r) {
          (r = r ? ": " + r : ""),
            t < e &&
              this.throwError(
                "missing argument" + r,
                tb.errors.MISSING_ARGUMENT,
                { count: t, expectedCount: e }
              ),
            t > e &&
              this.throwError(
                "too many arguments" + r,
                tb.errors.UNEXPECTED_ARGUMENT,
                { count: t, expectedCount: e }
              );
        }
        checkNew(t, e) {
          (t === Object || null == t) &&
            this.throwError("missing new", tb.errors.MISSING_NEW, {
              name: e.name,
            });
        }
        checkAbstract(t, e) {
        ...
        static globalLogger() {
          return tv || (tv = new tb("logger/5.7.0")), tv;
        }
        ...
        static setLogLevel(t) {
          let e = tm[t.toLowerCase()];
          if (null == e) {
            tb.globalLogger().warn("invalid log level - " + t);
            return;
          }
          tg = e;
        }
      ...
      (tb.errors = c), (tb.levels = l);
      let tw = new tb("bytes/5.7.0");
      function tM(t) {
        ...
        return (
          t.slice ||
            (t.slice = function () {
              ...
              return tE(new Uint8Array(Array.prototype.slice.apply(t, e)));
            }),
          t
        );
      }
      ...
      function tN(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          tw.checkSafeUint53(t, "invalid arrayify value");
          let e = [];
          for (; t; ) e.unshift(255 & t), (t = parseInt(String(t / 256)));
          return 0 === e.length && e.push(0), tE(new Uint8Array(e));
        }
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : tw.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
          for (let t = 0; t < r.length; t += 2)
            i.push(parseInt(r.substring(t, t + 2), 16));
          return tE(new Uint8Array(i));
        }
        return tI(t)
          ? tE(new Uint8Array(t))
          : tw.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tB(t, e) {
        return !(
          "string" != typeof t ||
      ...
      let tx = "0123456789abcdef";
      function tC(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          tw.checkSafeUint53(t, "invalid hexlify value");
          let e = "";
          for (; t; ) (e = tx[15 & t] + e), (t = Math.floor(t / 16));
        ...
        if (tI(t)) {
          ...
          for (let r = 0; r < t.length; r++) {
            let i = t[r];
            e += tx[(240 & i) >> 4] + tx[15 & i];
          }
          return e;
        }
        return tw.throwArgumentError("invalid hexlify value", "value", t);
      }
      function t_(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tC(t))
            : (!tB(t) || t.length % 2) &&
              tw.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function tO(t, e) {
        for (
          "string" != typeof t
            ? (t = tC(t))
            : tB(t) || tw.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
      ...
      function tR(t) {
        ...
        if ((tB(t) && !(t.length % 2)) || tI(t)) {
          let r = tN(t);
          64 === r.length
            ? ((e.v = 27 + (r[32] >> 7)),
              (r[32] &= 127),
              (e.r = tC(r.slice(0, 32))),
              (e.s = tC(r.slice(32, 64))))
            : 65 === r.length
            ? ((e.r = tC(r.slice(0, 32))),
              (e.s = tC(r.slice(32, 64))),
              (e.v = r[64]))
            : tw.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : tw.throwArgumentError(
          ...
          if (
            ...
            let r = (function (t, e) {
              ...
              return r.set(t, e - t.length), tE(r);
            })(tN(e._vs), 32);
            e._vs = tC(r);
            let i = r[0] >= 128 ? 1 : 0;
          ...
          let r = tN(e.s);
          r[0] >= 128 &&
            tw.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tC(r);
          e._vs &&
            (tB(e._vs) ||
              tw.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = tO(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      class tj {
        ...
        fromTwos(t) {
          return tK(tQ(this).fromTwos(t));
        }
        toTwos(t) {
          return tK(tQ(this).toTwos(t));
        }
        abs() {
          return "-" === this._hex[0] ? tj.from(this._hex.substring(1)) : this;
        }
        add(t) {
          return tK(tQ(this).add(tQ(t)));
        }
        sub(t) {
          return tK(tQ(this).sub(tQ(t)));
        }
        div(t) {
          return (
            tj.from(t).isZero() && tJ("division-by-zero", "div"),
            tK(tQ(this).div(tQ(t)))
          );
        }
        mul(t) {
          return tK(tQ(this).mul(tQ(t)));
        }
        mod(t) {
          let e = tQ(t);
          return (
            e.isNeg() && tJ("division-by-zero", "mod"), tK(tQ(this).umod(e))
          );
        }
        pow(t) {
          let e = tQ(t);
          return e.isNeg() && tJ("negative-power", "pow"), tK(tQ(this).pow(e));
        }
        and(t) {
          let e = tQ(t);
          return (
        ...
        eq(t) {
          return tQ(this).eq(tQ(t));
        }
        lt(t) {
          return tQ(this).lt(tQ(t));
        }
        lte(t) {
          return tQ(this).lte(tQ(t));
        }
        gt(t) {
          return tQ(this).gt(tQ(t));
        }
        gte(t) {
          return tQ(this).gte(tQ(t));
        }
        isNegative() {
          return "-" === this._hex[0];
        }
        isZero() {
          return tQ(this).isZero();
        }
        toNumber() {
          try {
            return tQ(this).toNumber();
          } catch {
        ...
        static from(t) {
          if (t instanceof tj) return t;
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tj(tq, tH(t))
              : t.match(/^-?[0-9]+$/)
              ? new tj(tq, tH(new tF(t)))
              : tL.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
          ...
          if ("bigint" == typeof t) return tj.from(t.toString());
          if (tI(t)) return tj.from(tC(t));
          if (t) {
            if (t.toHexString) {
              let e = t.toHexString();
              if ("string" == typeof e) return tj.from(e);
            } else {
              let e = t._hex;
              if (
                (null == e && "BigNumber" === t.type && (e = t.hex),
                "string" == typeof e &&
                  (tB(e) || ("-" === e[0] && tB(e.substring(1)))))
              )
                return tj.from(e);
            }
          }
          return tL.throwArgumentError("invalid BigNumber value", "value", t);
        }
      ...
      function tH(t) {
        if ("string" != typeof t) return tH(t.toString(16));
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tL.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tH(t)) ? t : "-" + t
          );
      ...
      function tQ(t) {
        ...
        return "-" === e[0]
          ? new tF("-" + e.substring(3), 16)
          : new tF(e.substring(2), 16);
      }
      function tJ(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tL.throwError(t, tb.errors.NUMERIC_FAULT, i)
        );
      }
      let tG = new tb(tT),
        tY = {},
      ...
      function tX(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tG.throwError(t, tb.errors.NUMERIC_FAULT, n)
        );
      }
      let tZ = "0";
      for (; tZ.length < 256; ) tZ += tZ;
      function t$(t) {
        if ("number" != typeof t)
          try {
        ...
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + tZ.substring(0, t)
          : tG.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function t0(t, e) {
        null == e && (e = 0);
        let r = t$(e),
      ...
      function t1(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tG.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tG.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tG.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          s = n[1];
      ...
      class t2 {
        constructor(t, e, r, i) {
          t !== tY &&
            ...
            (this._multiplier = t$(i)),
            Object.freeze(this);
        }
        static from(t) {
          if (t instanceof t2) return t;
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tG.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class t3 {
        ...
        addUnsafe(t) {
          this._checkFormat(t);
          let e = t1(this._value, this.format.decimals),
            r = t1(t._value, t.format.decimals);
          return t3.fromValue(e.add(r), this.format.decimals, this.format);
        }
        subUnsafe(t) {
          this._checkFormat(t);
          let e = t1(this._value, this.format.decimals),
            r = t1(t._value, t.format.decimals);
          return t3.fromValue(e.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(t) {
          this._checkFormat(t);
          let e = t1(this._value, this.format.decimals),
        ...
        floor() {
          ...
          1 === t.length && t.push("0");
          let e = t3.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(t6.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = t3.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(t6.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tG.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
          let r = t3.from("1" + tZ.substring(0, t), this.format),
            i = t8.toFormat(this.format);
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tG.throwArgumentError("invalid byte width", "width", t),
              tO(
                tj
                  .from(this._hex)
        ...
        toFormat(t) {
          return t3.fromString(this._value, t);
        }
        static fromValue(t, e, r) {
          ...
          return (
            ...
            null == e && (e = 0),
            null == r && (r = "fixed"),
            t3.fromString(t0(t, e), t2.from(r))
          );
        }
        static fromString(t, e) {
          ...
          !r.signed &&
            i.lt(tV) &&
            tX("unsigned value cannot be negative", "overflow", "value", t);
          let n = null;
          return new t3(
            tY,
            r.signed
              ? i.toTwos(r.width).toHexString()
              : tO(i.toHexString(), r.width / 8),
            t0(i, r.decimals),
            r
          );
        }
        static fromBytes(t, e) {
          null == e && (e = "fixed");
          let r = t2.from(e);
          if (tN(t).length > r.width / 8) throw Error("overflow");
          let i = tj.from(t);
          return (
        ...
        static from(t, e) {
          if ("string" == typeof t) return t3.fromString(t, e);
          if (tI(t)) return t3.fromBytes(t, e);
          try {
            return t3.fromValue(t, 0, e);
          } catch (t) {
            if (t.code !== tb.errors.INVALID_ARGUMENT) throw t;
          }
          return tG.throwArgumentError("invalid FixedNumber value", "value", t);
        }
      ...
      let t6 = t3.from(1),
        t8 = t3.from("0.5"),
        t4 = new tb("strings/5.7.0");
      function t5(t, e, r, i, n) {
      ...
      function t7(t, e = d.current) {
        e != d.current && (t4.checkNormalize(), (t = t.normalize(e)));
        let r = [];
        for (let e = 0; e < t.length; e++) {
      ...
      en(es),
        ...
        (function (t) {
          ...
          for (;;) {
            let r = t() - 1;
            if (r < 0) break;
            e.push(eo(1 + t(), 1 + r, t).map((t) => [t[0], t.slice(1)]));
          }
          (function (t) {
            let e = {};
            for (let r = 0; r < t.length; r++) {
      ...
      let eu = `Ethereum Signed Message:
`;
      function ef(t) {
        return (
          "string" == typeof t && (t = t7(t)),
          tk(
            (function (t) {
              let e = t.map((t) => tN(t)),
                r = new Uint8Array(e.reduce((t, e) => t + e.length, 0));
              return e.reduce((t, e) => (r.set(e, t), t + e.length), 0), tE(r);
            })([t7(eu), t7(String(t.length)), t])
          )
        );
      }
      new tb("rlp/5.7.0");
      let eh = new tb("address/5.7.0");
      function ea(t) {
        tB(t, 20) || eh.throwArgumentError("invalid address", "address", t);
      ...
      let el = {};
      for (let t = 0; t < 10; t++) el[String(t)] = String(t);
      for (let t = 0; t < 26; t++)
        el[String.fromCharCode(65 + t)] = String(10 + t);
      let ec = Math.floor(
        Math.log10
      ...
      tj.from(
        ...
        tO(em.toHexString(), 32),
        tO(ep.toHexString(), 32);
      var eg = {},
        ev = {};
      function eA(t, e) {
        if (!t) throw Error(e || "Assertion failed");
        ...
        (eI.prototype.update = function (t, e) {
          if (
            ...
            (this.pending = t.slice(t.length - r, t.length)),
              ...
              (t = ev.join32(t, 0, t.length - r, this.endian));
      ...
      (eB.ft_1 = function (t, e, r, i) {
        ...
        (eB.maj32 = eC),
        (eB.p32 = function (t, e, r) {
          return t ^ e ^ r;
        }),
        (eB.s0_256 = function (t) {
          return ex(t, 2) ^ ex(t, 13) ^ ex(t, 22);
        }),
        (eB.s1_256 = function (t) {
          return ex(t, 6) ^ ex(t, 11) ^ ex(t, 25);
        }),
        (eB.g0_256 = function (t) {
          return ex(t, 7) ^ ex(t, 18) ^ (t >>> 3);
        }),
        (eB.g1_256 = function (t) {
          return ex(t, 17) ^ ex(t, 19) ^ (t >>> 10);
        });
      var e_ = ev.rotl32,
        eO = ev.sum32,
        eR = ev.sum32_5,
      ...
      function eD() {
        if (!(this instanceof eD)) return new eD();
        eP.call(this),
          (this.h = [
      ...
      ev.inherits(eD, eP),
        ...
        (eD.hmacStrength = 80),
        (eD.padLength = 64),
        (eD.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = e_(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          for (i = 0; i < r.length; i++) {
            var h = ~~(i / 20),
              a = eR(e_(n, 5), ek(h, o, s, u), f, r[i], eU[h]);
            (f = u), (u = s), (s = e_(o, 30)), (o = n), (n = a);
          }
          (this.h[0] = eO(this.h[0], n)),
            (this.h[1] = eO(this.h[1], o)),
            (this.h[2] = eO(this.h[2], s)),
            (this.h[3] = eO(this.h[3], u)),
            (this.h[4] = eO(this.h[4], f));
        }),
        (eD.prototype._digest = function (t) {
          return "hex" === t
            ? ev.toHex32(this.h, "big")
      ...
      ev.inherits(eY, eJ),
        ...
        (eY.hmacStrength = 192),
        (eY.padLength = 64),
        (eY.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eF(eQ(r[i - 2]), r[i - 7], eK(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          (this.h[0] = eT(this.h[0], n)),
            ...
            (this.h[5] = eT(this.h[5], h)),
            (this.h[6] = eT(this.h[6], a)),
            (this.h[7] = eT(this.h[7], l));
        }),
        ...
        (eV.prototype._digest = function (t) {
          return "hex" === t
            ? ev.toHex32(this.h.slice(0, 7), "big")
            : ev.split32(this.h.slice(0, 7), "big");
        });
      var eW = ev.rotr64_hi,
        eX = ev.rotr64_lo,
        eZ = ev.shr64_hi,
      ...
      ev.inherits(e9, e5),
        ...
        (e9.hmacStrength = 192),
        (e9.padLength = 128),
        (e9.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
              ...
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = e3(n, o, s, u, f, h, a, l)),
              (r[i + 1] = e6(n, o, s, u, f, h, a, l));
          }
        }),
        (e9.prototype._update = function (t, e) {
          ...
          for (var y = 0; y < r.length; y += 2) {
            var b = v,
              ...
              x = r[y],
              C = r[y + 1],
              _ = e8(b, w, M, E, S, I, N, B, x, C),
              O = e4(b, w, M, E, S, I, N, B, x, C);
            b = (function (t, e) {
        ...
        (rt.prototype._digest = function (t) {
          return "hex" === t
            ? ev.toHex32(this.h.slice(0, 12), "big")
            : ev.split32(this.h.slice(0, 12), "big");
        }),
        (eN.sha1 = eD),
        (eN.sha224 = eV),
        (eN.sha256 = eY),
      ...
      ev.inherits(ru, rs),
        ...
        (ru.hmacStrength = 192),
        (ru.padLength = 64),
        (ru.prototype._update = function (t, e) {
          for (
            var r = this.h[0],
              i = this.h[1],
              n = this.h[2],
          ...
          (m = rn(this.h[1], n, a)),
            (this.h[1] = rn(this.h[2], o, l)),
            (this.h[2] = rn(this.h[3], s, u)),
            (this.h[3] = rn(this.h[4], r, f)),
            (this.h[4] = rn(this.h[0], i, h)),
            (this.h[0] = m);
        }),
        (ru.prototype._digest = function (t) {
          return "hex" === t
            ? ev.toHex32(this.h, "little")
            : ev.split32(this.h, "little");
        });
      var rh = [
      ...
      (rd.prototype._init = function (t) {
        ...
        (eg.hmac = rd),
        (eg.sha1 = eg.sha.sha1),
        (eg.sha256 = eg.sha.sha256),
        (eg.sha224 = eg.sha.sha224),
        (eg.sha384 = eg.sha.sha384),
        (eg.sha512 = eg.sha.sha512),
        (eg.ripemd160 = eg.ripemd.ripemd160);
      var rm = rg;
      function rg(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      ...
      function rM(t, e) {
        (this.type = t),
          (this.p = new tD(e.p, 16)),
          (this.red = e.prime ? tD.red(e.prime) : tD.mont(this.p)),
          (this.zero = new tD(0).toRed(this.red)),
          (this.one = new tD(1).toRed(this.red)),
          (this.two = new tD(2).toRed(this.red)),
          (this.n = e.n && new tD(e.n, 16)),
        ...
        (rM.prototype._wnafMulAdd = function (t, e, r, i, n) {
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var d = o - 1,
              p = o;
            if (1 !== f[d] || 1 !== f[p]) {
              (a[d] = ry(r[d], f[d], this._bitLength)),
                (a[p] = ry(r[p], f[p], this._bitLength)),
      ...
      var rS = rp(function (t) {
        ...
        rI = rA.assert;
      function rN(t) {
        rM.call(this, "short", t),
          (this.a = new tD(t.a, 16).toRed(this.red)),
          (this.b = new tD(t.b, 16).toRed(this.red)),
      ...
      function rB(t, e, r, i) {
        rM.BasePoint.call(this, t, "affine"),
          null === e && null === r
      ...
      function rx(t, e, r, i) {
        rM.BasePoint.call(this, t, "jacobian"),
      ...
      rS(rN, rM),
        (rN.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            if (t.beta) e = new tD(t.beta, 16).toRed(this.red);
            else {
              var e,
                r,
                i,
            ...
            if (t.lambda) r = new tD(t.lambda, 16);
            else {
              var o = this._getEndoRoots(this.n);
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rI(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tD(t.a, 16), b: new tD(t.b, 16) };
                  })
        ...
        (rN.prototype._getEndoRoots = function (t) {
          var e = t === this.p ? this.red : tD.mont(t),
            r = new tD(2).toRed(e).redInvm(),
            i = r.redNeg(),
            n = new tD(3).toRed(e).redNeg().redSqrt().redMul(r);
        ...
        (rN.prototype.pointFromX = function (t, e) {
          (t = new tD(t, 16)).red || (t = t.toRed(this.red));
          var r = t
              .redSqr()
              .redMul(t)
        ...
        rS(rB, rM.BasePoint),
        (rN.prototype.point = function (t, e, r) {
        ...
        rS(rx, rM.BasePoint),
        (rN.prototype.jpoint = function (t, e, r) {
          return new rx(this, t, e, r);
        }),
        (rx.prototype.toP = function () {
        ...
        (rx.prototype.mixedAdd = function (t) {
        ...
        (rx.prototype._zeroDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (rx.prototype._threeDbl = function () {
          var t, e, r;
          if (this.zOne) {
            var i = this.x.redSqr(),
              n = this.y.redSqr(),
        ...
        (rx.prototype.mul = function (t, e) {
          return (t = new tD(t, e)), this.curve._wnafMul(this, t);
        }),
        ...
        (rx.prototype.eqXToP = function (t) {
          var e = this.z.redSqr(),
      ...
      var rC = rp(function (t, e) {
        ...
        r_ = rp(function (t, e) {
          ...
          function n(t) {
            "short" === t.type
              ? (this.curve = new rC.short(t))
              : "edwards" === t.type
              ? (this.curve = new rC.edwards(t))
              : (this.curve = new rC.mont(t)),
              (this.g = this.curve.g),
              (this.n = this.curve.n),
              (this.hash = t.hash),
      ...
      (rO.prototype._init = function (t, e, r) {
        ...
        (rO.prototype.generate = function (t, e, r, i) {
          ...
          "string" != typeof e && ((i = r), (r = e), (e = null)),
            r && ((r = rv.toArray(r, i || "hex")), this._update(r));
      ...
      (rk.fromPublic = function (t, e, r) {
        return e instanceof rk ? e : new rk(t, { pub: e, pubEnc: r });
      }),
        (rk.fromPrivate = function (t, e, r) {
          return e instanceof rk ? e : new rk(t, { priv: e, privEnc: r });
        }),
      ...
      function rU(t, e) {
        ...
        this._importDER(t, e) ||
          (rP(t.r && t.s, "Signature without r or s"),
          (this.r = new tD(t.r, 16)),
          (this.s = new tD(t.s, 16)),
      ...
      function rj(t) {
        ...
        "string" == typeof t &&
          (rz(
            Object.prototype.hasOwnProperty.call(r_, t),
            "Unknown curve " + t
          ),
          (t = r_[t])),
          t instanceof r_.PresetCurve && (t = { curve: t }),
      ...
      (rj.prototype.keyPair = function (t) {
        ...
        (rj.prototype.genKeyPair = function (t) {
          ...
          for (
            var e = new rO({
              ...
              r = this.n.byteLength(),
              i = this.n.sub(new tD(2));
            ;

          ) {
            var n = new tD(e.generate(r));
        ...
        (rj.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            ...
            (t = this._truncateToN(new tD(t, 16)));
          for (
            var n = this.n.byteLength(),
              ...
              f = this.n.sub(new tD(1)),
              h = 0;
            ;
            h++
          ) {
            var a = i.k ? i.k(h) : new tD(u.generate(this.n.byteLength()));
            if (
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rU({ r: d, s: p, recoveryParam: m })
                    );
                  }
                }
              }
        ...
        (rj.prototype.recoverPubKey = function (t, e, r, i) {
          rz((3 & r) === r, "The recovery param is more than two bits"),
            (e = new rU(e, i));
          var n = this.n,
            o = new tD(t),
            s = e.r,
      ...
      let rK = new tb("signing-key/5.7.0"),
        rQ = null;
      function rJ() {
      ...
      class rG {
        constructor(t) {
          ed(this, "curve", "secp256k1"),
            ed(this, "privateKey", tC(t)),
            32 !==
              (function (t) {
                if ("string" != typeof t) t = tC(t);
                else if (!tB(t) || t.length % 2) return null;
                return (t.length - 2) / 2;
              })(this.privateKey) &&
          ...
          let e = rJ().keyFromPrivate(tN(this.privateKey));
          ed(this, "publicKey", "0x" + e.getPublic(!1, "hex")),
            ed(this, "compressedPublicKey", "0x" + e.getPublic(!0, "hex")),
            ed(this, "_isSigningKey", !0);
        }
        _addPoint(t) {
          let e = rJ().keyFromPublic(tN(this.publicKey)),
            r = rJ().keyFromPublic(tN(t));
        ...
        signDigest(t) {
          let e = rJ().keyFromPrivate(tN(this.privateKey)),
            r = tN(t);
          32 !== r.length &&
            rK.throwArgumentError("bad digest length", "digest", t);
          let i = e.sign(r, { canonical: !0 });
          return tR({
            recoveryParam: i.recoveryParam,
            r: tO("0x" + i.r.toString(16), 32),
            s: tO("0x" + i.s.toString(16), 32),
          });
        }
        computeSharedSecret(t) {
          let e = rJ().keyFromPrivate(tN(this.privateKey)),
            r = rJ().keyFromPublic(tN(rY(t)));
          return tO("0x" + e.derive(r.getPublic()).toString(16), 32);
        }
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    eh.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      eh.throwArgumentError("bad icap checksum", "address", t),
                      e = new tF(t.substring(4), 36).toString(16);
                    e.length < 40;

                  )
                    e = "0" + e;
                  e = ea("0x" + e);
                } else eh.throwArgumentError("invalid address", "address", t);
                return e;
              })(
                t_(
                  tk(
                      ...
                      rY(
                        (function (t, e) {
                          ...
                          return (
                            "0x" +
                            rJ()
                              .recoverPubKey(tN(t), i, r.recoveryParam)
                              .encode("hex", !1)
                          );
                        })(tN(ef(e)), s)
                      ),
      ...
      var rX = Object.defineProperty,
        ...
        r6 = (t, e) => {
          ...
          if (r0) for (var r of r0(e)) r2.call(e, r) && r3(t, r, e[r]);
          return t;
        },
        r8 = (t, e) => rZ(t, r$(e));
      let r4 = (t) => t?.split(":"),
...
`)
      ...
      function iN(t) {
        let e = iS("u" > typeof t.type ? t.type : 0);
        if (iI(e) === iv && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let r =
            "u" > typeof t.senderPublicKey
              ? (0, N.mL)(t.senderPublicKey, id)
              : void 0,
          i = "u" > typeof t.iv ? (0, N.mL)(t.iv, id) : (0, E.randomBytes)(12);
        return i_({
          type: e,
          sealed: new w.OK((0, N.mL)(t.symKey, id)).seal(
            i,
            (0, N.mL)(t.message, ig)
          ),
          iv: i,
      ...
      function iB(t, e) {
        ...
        return i_({ type: r, sealed: (0, N.mL)(t, ig), iv: i, encoding: e });
      }
      function ix(t) {
      ...
      function iC(t, e) {
        let { sealed: r } = iO({ encoded: t, encoding: e });
        return (0, N.BB)(r, ig);
      }
      function i_(t) {
        let { encoding: e = ip } = t;
      ...
      function iR(t, e) {
        let r = iO({ encoded: t, encoding: e?.encoding });
        return ik({
          type: iI(r.type),
          senderPublicKey:
            "u" > typeof r.senderPublicKey
              ? (0, N.BB)(r.senderPublicKey, id)
              : void 0,
      ...
      var iL = Object.defineProperty,
        ...
        iQ = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        iJ = (t, e) => {
          for (var r in e || (e = {})) iH.call(e, r) && iQ(t, r, e[r]);
          if (ij) for (var r of ij(e)) iK.call(e, r) && iQ(t, r, e[r]);
          return t;
        },
        iG = (t, e) => iq(t, iz(e));
      function iY(t) {
      ...
      function i1(t, e) {
        let { message: r, code: i } = i0[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function i2(t, e) {
        let { message: r, code: i } = i$[t];
        return { message: e ? `${r} ${e}` : r, code: i };
      }
      function i3(t, e) {
        return (
      ...
      function nn(t) {
        let e = !0;
        return (
          i3(t) ? t.length && (e = t.every((t) => i4(t, !1))) : (e = !1), e
        );
      }
      function no(t, e) {
        let r = null;
      ...
      function nd(t) {
        return !(i8(t) || !i4(t.method, !1));
      }
      function np(t) {
        return !(
          i8(t) ||
          (i8(t.result) && i8(t.error)) ||
          !i5(t.id, !1) ||
          !i4(t.jsonrpc, !1)
        );
      }
      function nm(t) {
        return !(i8(t) || !i4(t.name, !1));
      }
      function ng(t, e) {
        return !(
          !i9(e) ||
      ...
      function nv(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                iX(t.accounts).includes(e) && r.push(...t.methods);
              }),
              r
            );
          })(t, e).includes(r)
      ...
      function nA(t, e, r) {
        return (
          ...
          (function (t, e) {
            ...
            return (
              Object.values(t).forEach((t) => {
                iX(t.accounts).includes(e) && r.push(...t.events);
              }),
              r
            );
          })(t, e).includes(r)
