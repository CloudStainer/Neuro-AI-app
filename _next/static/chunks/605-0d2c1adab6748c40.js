  ...
  [605],
  {
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 4:
                    ...
                    return (
                      (window.location.href = "https://neuro-ai-app.vercel.app/dashboard/"),
                      t.abrupt("return")
                    );
                  case 8:
                    if (!(!e || !(e in l))) {
    ...
    25566: function (t) {
      ...
      function f() {
        s &&
          n &&
          ((s = !1), n.length ? (c = n.concat(c)) : (l = -1), c.length && p());
      }
      function p() {
        if (!s) {
          var t = i(f);
    ...
    60440: function (t, e, r) {
      var n = r(56191).default,
        o = r(96406);
      (t.exports = function (t, e) {
