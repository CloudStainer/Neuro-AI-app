(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7210],
  {
          ...
          super(),
            ...
            (this.handlers = {
              handshake: async (e) => {
                try {
                  if (this.connected)
                    return (
                      this.emit("connect", {
                        chainId: (0, d.hexStringFromIntNumber)(
              ...
              state: (e) => {
                ...
                switch (e.method) {
                  case "eth_chainId":
                    return (0, d.hexStringFromIntNumber)(
                      (0, c.IntNumber)(this.chain.id)
                    );
                  case "net_version":
            ...
            (this.updateListener = {
              onAccountsUpdate: ({ accounts: e, source: t }) => {
                (0, d.areAddressArraysEqual)(this.accounts, e) ||
                  ((this.accounts = e),
                  "storage" !== t &&
              ...
              onChainUpdate: ({ chain: e, source: t }) => {
                (e.id !== this.chain.id || e.rpcUrl !== this.chain.rpcUrl) &&
                  ...
                  "storage" !== t &&
                    this.emit(
                      "chainChanged",
                      (0, d.hexStringFromIntNumber)((0, c.IntNumber)(e.id))
                    ));
              },
            }),
            (this.metadata = n),
          ...
          return (
            ...
            a(e.code)
              ...
              : ((r.code = s.standardErrorCodes.rpc.internal),
                (r.message = d(e, "message") ? e.message : n),
                (r.data = { originalError: o(e) })),
    ...
    18089: function (e, t, r) {
      "use strict";
      var s = r(82957).Buffer;
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.loadSignerType = function () {
        ...
        (t.createSigner = function (e) {
          ...
          switch (t) {
            ...
            case "walletlink":
              return new n.WalletLinkSigner({ metadata: r, updateListener: c });
            case "extension": {
            ...
            (c = this.ui.showConnecting({
              ...
              onCancel: (e) => {
                this.publishWeb3RequestCanceledEvent(d),
                  this.handleErrorResponse(d, a.method, e),
                  null == c || c();
              },
              onResetConnection: this.resetAndReload,
            })),
    ...
    25123: function (e, t, r) {
      ...
      (t.generateKeyPair = n),
        ...
        (t.encrypt = a),
        (t.decrypt = o),
        (t.exportKeyToHexString = d),
        (t.importKeyFromHexString = l),
        (t.encryptContent = u),
        (t.decryptContent = h);
    },
    48104: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    80391: function (e, t, r) {
      ...
      function l(e, t) {
        ...
        if ("bytes" === e)
          return (
            (t = new s(t)),
            (u = s.concat([l("uint256", t.length), t])),
            t.length % 32 != 0 &&
              (u = s.concat([u, n.zeros(32 - (t.length % 32))])),
            u
          );
        if (e.startsWith("bytes")) {
          ...
          return (r = o(e)), l("int256", d(t) * BigInt(2) ** BigInt(r[1]));
      ...
      e.exports = {
        rawEncode: function (e, t) {
          ...
          for (var o in e) {
            var d = i(e[o]),
              u = l(d, t[o]);
            "string" === d || "bytes" === d || "dynamic" === c(d)
              ? (r.push(l("uint256", a)), n.push(u), (a += u.length))
              : r.push(u);
          }
